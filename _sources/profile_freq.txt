...
Overview
-------------
``profile_freq`` is a program within the sortseq package which calculates the
frequency of each base (or amino acid) at each position in the library.
...
Example Command to Run the analysis::
    ...
    sortseq profile_freq -i data.txt -o freqs.txt
